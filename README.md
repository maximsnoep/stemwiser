...
[Stemwiser.nl](https://stemwiser.nl) is a web-based tool that helps users explore their political preferences ahead of the Dutch parliamentary elections and municipal elections.
...
The data is sourced from the [ProDemos](https://stemwijzer.nl/). 
